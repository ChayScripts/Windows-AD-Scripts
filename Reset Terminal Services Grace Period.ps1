# script Source: https://gallery.technet.microsoft.com/scriptcenter/Reset-Terminal-Server-RDS-44922d91
# now available at: https://web.archive.org/web/20171030111329/https://gallery.technet.microsoft.com/scriptcenter/Reset-Terminal-Server-RDS-44922d91
